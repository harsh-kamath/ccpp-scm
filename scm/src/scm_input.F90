...
subroutine get_case_init_DEPHY(scm_state, scm_input)
  ...
  if (trim(input_surfaceForcingLSM) == 'lsm') then
    ...
    scm_input%input_vegtyp   = input_vegtyp(active_init_time)
    scm_input%input_soiltyp  = input_soiltyp(active_init_time)
    scm_input%input_slopetype = input_slopetype(active_init_time)
    scm_input%input_scolor   = input_scolor(active_init_time)
